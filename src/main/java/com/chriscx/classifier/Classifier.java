...
public abstract class Classifier<T, K> implements IFeatureProbability<T, K> {
     ...
     */
    private static int INITIAL_CATEGORY_DICTIONARY_CAPACITY = 16;
     ...
     */
    private static int INITIAL_FEATURE_DICTIONARY_CAPACITY = 32;
     ...
     * Constructs a new classifier without any trained knowledge.
     */
    public Classifier(int INITIAL_CATEGORY_DICTIONARY_CAPACITY, 
            int INITIAL_FEATURE_DICTIONARY_CAPACITY, int memoryCapacity) {
        
        Classifier.INITIAL_CATEGORY_DICTIONARY_CAPACITY = INITIAL_CATEGORY_DICTIONARY_CAPACITY;
        Classifier.INITIAL_FEATURE_DICTIONARY_CAPACITY = INITIAL_FEATURE_DICTIONARY_CAPACITY;
     ...
     *
     * @see
     * de.daslaboratorium.machinelearning.classifier.Classifier#featureProbability(Object,
     * Object)
     * @see
     * de.daslaboratorium.machinelearning.classifier.Classifier#featureWeighedAverage(Object,
