...
public class App {
    ...
    public static void listFilesForFolder(final File folder, Set list) throws IOException {
        for (final File fileEntry : folder.listFiles()) {
            if (fileEntry.isDirectory()) {
                listFilesForFolder(fileEntry, list);
            } else {
                System.out.println("add " + fileEntry.getCanonicalPath());
                list.add(fileEntry.getAbsolutePath());
            }
        }
    }

//    public static void copyDirectoryTree(final File src, final File dest) throws IOException {
//        if (!dest.exists()) {
//            dest.mkdir();
//        }
//        for (final File fileEntry : src.listFiles()) {
//            if (fileEntry.isDirectory()) {
//                File newDir = new File(dest, fileEntry.getName());
//                System.out.println("copy dir" + fileEntry.getCanonicalPath() + " to "
//                        + newDir.getCanonicalPath());
//                copyDirectoryTree(fileEntry, newDir);
//            } else {
//                System.out.println("ignore copy " + fileEntry.getAbsolutePath());
//            }
//        }
//    }
